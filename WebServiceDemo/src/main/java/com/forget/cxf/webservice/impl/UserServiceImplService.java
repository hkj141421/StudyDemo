 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://Impl.webservice.cxf.forget.com/", wsdlLocation = "http://localhost:7777/ws/userservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://Impl.webservice.cxf.forget.com/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7777/ws/userservice?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://Impl.webservice.cxf.forget.com/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Impl.webservice.cxf.forget.com/", "UserServiceImplPort"), UserService.class, features);
    }
