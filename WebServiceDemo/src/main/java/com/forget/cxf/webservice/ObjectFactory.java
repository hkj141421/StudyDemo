...
package com.forget.cxf.webservice;
 ...
 * generated in the com.forget.cxf.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetInfo_QNAME = new QName("http://webservice.cxf.forget.com/", "getInfo");
    private final static QName _GetInfoResponse_QNAME = new QName("http://webservice.cxf.forget.com/", "getInfoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.forget.cxf.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.cxf.forget.com/", name = "getInfo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.cxf.forget.com/", name = "getInfoResponse")
